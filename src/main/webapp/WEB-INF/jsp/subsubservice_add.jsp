...
<script>
    ...
    function submitForm() {
        ...
        xhr.open('POST', '/subsubserviceadd');
        xhr.onload = function() {
            if (xhr.status === 200) {
...
<div id="add1" class="modal custom-modal fade" role="dialog">
    ...
    <div class="form-group">
        ...
        <input name="title" id="title" class="form-control" type="text" >
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="col-form-label">sub service id <span class="text-danger">*</span></label>
                        <input name="subserviceId" required class="form-control" type="text" value="<%= subserviceId %>">
                    </div>
                </div>
