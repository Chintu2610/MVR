...
<script>
    ...
    function submitForm() {
        ...
        xhr.open('POST', '/TrainingScheduleadd');
        xhr.onload = function() {
            if (xhr.status === 200) {
        ...
        <select name="trainingid" required class="form-control">
            ...
            <script>
                ...
                fetch('/trainingDropdown')
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        <label class="col-form-label">startDate <span class="text-danger">*</span></label>
                      ...
                      <div class="col-md-12">
                    <div class="form-group">
                        <label class="col-form-label">endDate<span class="text-danger">*</span></label>
          ...
          <div class="col-md-12">
                    <div class="form-group">
                        <label class="col-form-label">timings <span class="text-danger">*</span></label>
                        <input name="timings" required class="form-control" type="text">
                    </div>
                </div> 
