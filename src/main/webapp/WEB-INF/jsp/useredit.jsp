...
<body>
            ...
            <form id="editForm" action="/usereedit" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="editname" name="name" class="form-control"></textarea>
                    </div>
                    
                    <div class="form-group">
                        <label class="col-form-label">email</label>
                        <input id="editemail" name="email" class="form-control" type="text">
                </div>
                 
                 
                                     
                    <div class="form-group">
                        <label class="col-form-label"> phoneNum <span class="text-danger">*</span></label>
                        <input id="editphoneNum" name="phoneNum" required class="form-control" type="text">
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-form-label">paid250</label>
                        <input id="editpaid250" name="paid250" class="form-control" type="text">
                </div>  
                
                   <div class="form-group">
                        <label class="col-form-label">approvestatus</label>
                        <input id="editapprovestatus" name="approvestatus" class="form-control" type="text">
                </div>  
