...
<body>
            ...
            <form id="editForm" action="/trainingedit" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-form-label">Training Id</label>
                        ...
                        <textarea id="edittrainingname" name="trainingname" class="form-control"></textarea>
                    </div>
