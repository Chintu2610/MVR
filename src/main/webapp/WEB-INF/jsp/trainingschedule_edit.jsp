...
<body>
            ...
            <form id="editForm" action="TrainingScheduleedit" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="edittrainingscheduleid" name="trainingscheduleid" required class="form-control" type="text">
                    </div>
                    
                    <div class="form-group">
                        <label class="col-form-label"> Training ID <span class="text-danger">*</span></label>
                        <input id="edittrainingid" name="trainingid" required class="form-control" type="text">
                    </div>
             

  						 <div class="form-group">																																																															                  <div class="form-group">
                        <label class="col-form-label">startDate</label>
                        <textarea id="editstartDate" name="startDate" class="form-control"></textarea>
                    </div>
                    
                    <div class="form-group">
                        <label class="col-form-label">endDate</label>
                        <input id="editendDate" name="endDate" class="form-control" type="text">
                </div>
                 ...
                 <div class="form-group">																																																															                  <div class="form-group">
                        ...
                        <textarea id="edittimings" name="timings" class="form-control"></textarea>
                    </div>
